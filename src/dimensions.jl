...
from_parent_dims(::Type{<:SubIndex{N,I}}) where {N,I} = _from_sub_dims(I)
...
from_parent_dims(::Type{<:PermutedIndex{<:Any,<:Any,I}}) where {I} = static(Val(I))
...
to_parent_dims(::Type{<:PermutedIndex{<:Any,I}}) where {I} = static(Val(I))
to_parent_dims(::Type{<:SubArray{T,N,A,I}}) where {T,N,A,I} = _to_sub_dims(I)
to_parent_dims(::Type{<:SubIndex{N,I}}) where {N,I} = _to_sub_dims(I)
...
has_dimnames(::Type{T}) where {T} = _has_dimnames(dimnames(T))
