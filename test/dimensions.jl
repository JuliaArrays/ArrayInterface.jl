...
@testset "dimnames" begin
    ...
    @test @inferred(ArrayInterface.has_dimnames(x)) === static(true)
    @test @inferred(ArrayInterface.has_dimnames(ones(2,2))) === static(false)
    @test @inferred(ArrayInterface.has_dimnames(Array{Int,2})) === static(false)
    @test @inferred(ArrayInterface.has_dimnames(typeof(x))) === static(true)
    @test @inferred(ArrayInterface.has_dimnames(typeof(view(x, :, 1, :)))) === static(true)
